...
const MainPreview = ({ 
  ...
  // Determine what to display in the preview pane
          ...
          <div className="preview-footer">
            <div className="d-flex justify-content-between align-items-center">
              <div>
                ...
                <span className="text-muted small">{activeResult.size}</span>
              </div>
              <Button 
                variant="primary"
              ...
              <>
                ...
                <div>
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    <h6 className="mb-0">All Processed Formats</h6>
                    <Button 
                      variant="outline-primary" 
                      size="sm"
                      className="d-flex align-items-center gap-1"
                      onClick={() => {
                        alert("In production, this would download a zip with all formats.");
                      }}
                    >
    ...
    return (
      <div className="empty-preview">
        ...
        <div className="mt-4 text-muted">
          <p>Supported formats: PNG, JPEG, GIF, BMP, TIFF, WebP</p>
  ...
  return (
    <div className="main-preview-pane h-100">
      <div className={`panel main-preview-container ${activeStep === 3 ? 'panel-active' : ''}`}>
        <div className="panel-header">
          <h3 className="panel-title">
            {activeResult ? (
              <div className="d-flex align-items-center">
                <Images className="me-2" /> Processing Results
                {activeStep === 3 && <span className="ms-2 badge bg-success">Step 3: Complete</span>}
              </div>
            ) : (
              <div className="d-flex align-items-center">
                <FileImage className="me-2" /> Image Preview
                {activeStep === 1 && preview && <span className="ms-2 badge bg-primary">Step 1 Complete</span>}
              </div>
            )}
          </h3>
        </div>
